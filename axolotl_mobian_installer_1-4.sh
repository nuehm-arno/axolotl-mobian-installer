#!/bin/sh
# This script installs or updates Axolotl to the latest version from https://github.com/nanu-c/axolotl and should only be used on Mobian devices by "sh axolotl_mobian_installer_1-4.sh". Please restart before executing. The update is quite fast but the first installation will take up to 45 min. So please be patient... And disable 'Settings - Power - Automatic Suspend' for that period of time.
